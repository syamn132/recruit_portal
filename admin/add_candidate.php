...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt = $pdo->prepare("
            ...
            (name, email, phone, dob, password, verified, is_temp_password) 
            VALUES (?, ?, ?, ?, ?, ?, 1)
        ");
        
        if ($stmt->execute([$name, $email, $phone, $dob, $hashed_password, $verified])) {
            $_SESSION['success'] = "Candidate added successfully! Temporary password: $temp_password";
        ...
        if ($e->errorInfo[1] == 1062) {
            ...
            $_SESSION['error'] = "Error adding candidate: " . $e->getMessage();
        }
