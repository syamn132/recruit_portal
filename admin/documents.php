...
<html
  ...
  <head>
    ...
    <title>Verify Documents | SoT</title>
      ...
      <table class="table table-hover">
        <thead>
          <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" onclick="sortTable(1)">Document Type</th>
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" onclick="sortTable(2)">Uploaded At</th>
        ...
        <tbody class="divide-y divide-gray-200" id="tableBody">
          ...
          <tr>
            <td class="px-6 py-4"><?= htmlspecialchars($doc['candidate_name']) ?></td>
            <td class="px-6 py-4 capitalize"><?= str_replace('_', ' ', $doc['type']) ?></td>
            <td class="px-6 py-4"><?= date('M d, Y H:i', strtotime($doc['uploaded_at'])) ?></td>
            <td class="px-6 py-4">
