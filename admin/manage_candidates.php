...
if (isset($_GET['delete'])) {
    ...
    try {
        ...
        $pdo->exec("DELETE FROM test_results WHERE candidate_id = $id");
        $pdo->exec("DELETE FROM documents WHERE candidate_id = $id");
        $pdo->exec("DELETE FROM offer_letters WHERE candidate_id = $id");
...
<html
  ...
  <head>
    ...
    <title>Manage Candidates | SoT</title>
            ...
            <li class="menu-item active open">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item active">
                  <a href="manage_candidate.php" class="menu-link">
        ...
        <tbody class="divide-y divide-gray-200" id="tableBody">
          ...
          <tr>
            ...
            <td class="px-6 py-4 space-x-2">
              <a href="edit_candidate.php?id=<?= $candidate['id'] ?>" class="text-blue-500 hover:text-blue-700">Edit</a>
              &nbsp;
              <a href="candidates.php?delete=<?= $candidate['id'] ?>" class="text-red-500 hover:text-red-700" onclick="return confirm('Are you sure you want to delete this candidate?')">Delete</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
