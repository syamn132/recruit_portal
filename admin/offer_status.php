...
// Fetch all offer letters with candidate info
$stmt = $pdo->query("
...
$candidates = $pdo->query("SELECT id, name FROM candidates")->fetchAll();
?>
                      ...
                      <table class="table table-hover">
                        <thead>
                          <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" onclick="sortTable(1)">CTC</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" onclick="sortTable(2)">Monthly In-hand</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" onclick="sortTable(3)">Joining Date</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" onclick="sortTable(4)">Status</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase" onclick="sortTable(5)">Document</th>
                          </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200" id="tableBody">
                          <?php foreach ($offers as $offer): ?>
                          <tr>
                            <td class="px-6 py-4"><?= $offer['candidate_name'] ?></td>
                            <td class="px-6 py-4">₹<?= number_format($offer['ctc'], 2) ?></td>
                            <td class="px-6 py-4">₹<?= number_format($offer['monthly_inhand'], 2) ?></td>
                            <td class="px-6 py-4"><?= $offer['joining_date'] ?></td>
                            <td class="px-6 py-4">
                                <?= $offer['accepted'] ? '✅ Accepted' : '❌ Pending' ?>
                            </td>
                            <td class="px-6 py-4">
                                <a href="<?= $offer['file_path'] ?>" target="_blank" class="text-blue-500 hover:underline">
                                    View Offer
                                </a>
                            </td>
                          </tr>
