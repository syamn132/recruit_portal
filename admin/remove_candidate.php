        ...
        <tbody class="divide-y divide-gray-200" id="tableBody">
          ...
          <tr>
            ...
            <td class="px-6 py-4 space-x-2">
              <a href="candidates.php?delete=<?= $candidate['id'] ?>" class="text-red-500 hover:text-red-700" onclick="return confirm('Are you sure you want to delete this candidate?')">Remove</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
